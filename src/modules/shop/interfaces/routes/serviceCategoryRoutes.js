...
const findServiceCategoryController = require("../controllers/serviceCategory/FindServiceCategoryByIdController");
...
router.get( "/serviceCategory/:id",authMiddleware,findServiceCategoryController.find);
